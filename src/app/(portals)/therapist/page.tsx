    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            {todayBookings.length > 0 && (
                <div className="bg-secondary-green/5 border border-secondary-green/20 rounded-2xl p-6 mb-8">
                    <h2 className="text-lg font-semibold text-secondary-green mb-4 flex items-center gap-2">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {isOngoing && (
                                                <span className="px-2 py-1 bg-secondary-green text-white text-xs font-medium rounded-full">
                                                    In Progress
                                                </span>
                                            )}
