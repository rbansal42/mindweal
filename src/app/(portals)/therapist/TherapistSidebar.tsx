...
const navItems = [
    ...
    { href: "/therapist/schedule", icon: Calendar, label: "Schedule" },
    { href: "/therapist/availability", icon: Clock, label: "Availability" },
    { href: "/therapist/bookings", icon: List, label: "All Bookings" },
    { href: "/therapist/settings", icon: Settings, label: "Settings" },
];

export default function TherapistSidebar({ user, therapist }: TherapistSidebarProps) {
